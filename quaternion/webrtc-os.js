// Implements WebRTC-FS 

// Concepts
// opening a datachannel is equal to a syscall or posix command we support both interfaces
// for convinience and interop this also implements stdio, fs, net via webrtc as common transport.
import * from './wasi.interface.js'
export class Fd {
  fd_advise(
